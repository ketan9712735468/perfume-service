                                ...
                                <table class="w-full table-auto">
                                    <thead>
                                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                            ...
                                            <th class="py-3 px-6 text-left">Latest Result File</th>
                                        ...
                                        @foreach($projects as $project)
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                                    <a href="{{ route('projects.show', $project) }}" class="text-blue-500 hover:text-blue-600 flex items-center space-x-1">
                                                ...
                                                <td class="py-4 px-6 align-start text-center">
                                                    <div class="inline-flex items-center space-x-4">
                                                        ...
                                                        <button type="button" onclick="openModal('{{ route('projects.destroy', $project) }}')" class="text-gray-600 hover:text-gray-800">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
